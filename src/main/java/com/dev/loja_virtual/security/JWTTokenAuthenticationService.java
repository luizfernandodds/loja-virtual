...
import com.dev.loja_virtual.util.ApplicationContextLoad;
...
public class JWTTokenAuthenticationService {
	...
	public void addAuthentication(HttpServletResponse response, String username) throws Exception {
		...
		SystemUser user = ApplicationContextLoad.
				getApplicationContext().
				getBean(SystemUserRepository.class).findUserByLogin(username);
	...
	public Authentication getAuthetication(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (token != null) {
			...
			if (user != null) {
				...
				SystemUser user2 = ApplicationContextLoad.
						getApplicationContext().
						getBean(SystemUserRepository.class).findUserByLogin(user);
